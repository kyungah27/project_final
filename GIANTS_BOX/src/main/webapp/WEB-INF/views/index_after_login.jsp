...
<body>
            ...
            <div class="container-fluid"><a href="main.do"><img src="${context}/resources/img/logo2.png" style="width: 208px;/*filter: blur(0px);*/"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1" style="background-color: rgba(255,255,255,0.41);"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    ...
                    <ul class="nav navbar-nav ml-auto">
                    	<li class="nav-item" role="presentation"><a class="nav-link text-white" href="login.do">explore</a></li>
                    	<li class="nav-item" role="presentation"><a class="nav-link text-white" href="login.do">my event</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link text-white" href="login.do">my account</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link text-white" href="login.do">log out</a></li>
                    </ul>
            </div>
            </div>
        </nav>
    ...
    <main class="page landing-page" style="padding: 0;">
        ...
        <section class="clean-block clean-info dark">
            <div class="container">
                <div class="d-flex flex-column justify-content-between block-heading" style="margin-bottom: 7px;">
                    <h2 class="text-primary">Films for Events</h2><a class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-end justify-content-sm-end justify-content-md-end justify-content-lg-end justify-content-xl-end align-items-xl-center" href="#">See more</a></div>
                <div
                    class="row">
                    <div class="col-md-6 col-lg-4" style="margin-bottom: 10px;">
                        <div class="card"><img class="card-img-top w-100 d-block" src="${context}/resources/img/movie_rank/rank1.jpg">
                            ...
                            <div class="text-center" style="margin-bottom: 20px;"><button class="btn btn-outline-primary btn-sm" type="button">관련 이벤트</button></div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4" style="margin-bottom: 10px;">
